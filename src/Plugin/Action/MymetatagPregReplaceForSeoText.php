...
/**
 * Mymetatag preg_replace for SEO text.
 *
 * @Action(
 *   id = "mymetatag_preg_replace_for_seo_text",
 *   label = @Translation("Mymetatag preg_replace for SEO text"),
 *   type = "mymetatag"
 * )
 */
class MymetatagPregReplaceForSeoText extends ConfigurableActionBase {
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    $form['text_search'] = [
      '#type' => 'textfield',
      '#title' => t('Text search'),
      '#description' => t('The text search for function preg_replace'),
    ...
    $form['text_replace'] = [
      ...
      '#description' => t('The text replace for function preg_replace'),
  ...
  public function execute($entity = NULL) {
    ...
    if ($seo_text) {
      ...
      $new_seo_text = preg_replace($text_search, $text_replace, $seo_text);
